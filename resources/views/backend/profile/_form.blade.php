<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
            {!! Form::text('username',null, ['class' => 'form-control','required','disabled','placeholder'=>'Bắt buộc']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
            {!! Form::email('email',null, ['class' => 'form-control','required','disabled','placeholder'=>'Bắt buộc']) !!}
            </div>
        </div>
