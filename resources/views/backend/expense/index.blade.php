...
@section('body-append')
    ...
    <script>
		...
		$(function(){
			renderTable('{!! route('admin.expense.data') !!}',
			    [
		    	...
		    	createdRow: function ( row, data, index ) {
		    		...
		    		$('td',row).eq(2).html(toLocaleCurrency(data.price));
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ route('admin.expense.create') }}" class="btn btn-success btn-xs create-link"> <i class="fa fa-plus"></i> {{trans('repositories.create')}}</a>
                    </div>
                    @endcan
                </div>
