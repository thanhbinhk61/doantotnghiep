...
@section('body-append')
    ...
    <script>
		...
		$(function(){
			renderTable('{!! route('admin.slide.data') !!}',
			    [
			        ...
			        { data: 'category', orderable: false, name: 'category'},
		    	...
		    	createdRow: function ( row, data, index ) {
		    		...
		    		$('td',row).eq(4).html(data.section==1 ? 'Trang chủ' : 'Trang danh mục');
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="{{ route('admin.slide.create') }}" class="btn btn-success btn-xs create-link"> <i class="fa fa-plus"></i> {{trans('repositories.create')}}</a>
                    </div>
                    @endcan
                </div>
