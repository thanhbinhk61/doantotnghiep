(function($){
    ...
    $(document).ready(function() {
        ...
        $('.slider-range-price').each(function(){
            ...
            $( this ).slider({
              ...
              slide: function( event, ui ) {
                ...
                $('span.amount-rance-filter').attr('data-min',ui.values[0]).attr('data-max',ui.values[1]);
              }
            });
        })
        ...
        $(document).on('click','.colse-cate',function(){
            ...
            $(this).addClass('open-cate').removeClass('colse-cate').html('Sản phẩm khác');
            return false;
        })
        // bar ontop click
        ...
        /* Product qty */
        // $(document).on('click','a.btn-plus-down',function(){
        //     //console.log('tien');
        ...
        //     return false;
        // })
        // $(document).on('click','a.btn-plus-up',function(){
        //     var value = parseInt($('.option-product-qty').val());
        //     value = value +1;
        //     if(value <=0) return false;
        //     $('.option-product-qty').val(value);
